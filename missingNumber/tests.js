const findMissing = require('./library.js');

describe("Find missing number two lists: ", function() {

  describe("Case for non arrays", function() {

    it("should throw exception for non-arrays", function() {
      expect(findMissing('j', 'k')).toEqual("Inputs should be arrays");
    });
